...
import 'leaderboard_detail_screen.dart' show LeaderboardMember;
...
class LeaderboardPodiumScreen extends StatefulWidget {
  ...
  @override
  State<LeaderboardPodiumScreen> createState() =>
      _LeaderboardPodiumScreenState();
}

class _LeaderboardPodiumScreenState extends State<LeaderboardPodiumScreen>
                  ...
                  children: [
                    ...
                    FutureBuilder<List<LeaderboardMember>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        LeaderboardMember? top1, top2, top3;
                        try {
