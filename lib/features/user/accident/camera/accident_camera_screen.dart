...
class AccidentCameraWarmupService {
  AccidentCameraWarmupService._();
  static final AccidentCameraWarmupService instance = AccidentCameraWarmupService._();
  ...
  Future<void> warmUp() async {
    ...
    try {
      ...
      debugPrint('Error warming up Accident camera: $e');
    } finally {
      isWarming = false;
    }
  }
...
class _AccidentCameraScreenState extends State<AccidentCameraScreen> with WidgetsBindingObserver {
  ...
  static const Color _kAccent = Color.fromARGB(255, 216, 29, 29);
  ...
  Future<void> _initCamera() async {
    final warm = AccidentCameraWarmupService.instance;
    ...
    try {
      ...
      debugPrint('Error initializing Accident camera: $e');
    }
  }
  ...
  Future<void> _setCamera(int index) async {
    ...
    try {
      ...
      debugPrint('Error setting Accident camera: ${e.code}\n${e.description}');
    }
  }
  ...
  Future<void> _takePicture() async {
    ...
    try {
      ...
      debugPrint('Error taking Accident picture: ${e.code}\n${e.description}');
      if (mounted) {
  ...
  Future<void> _pickFromGallery() async {
    try {
      ...
      debugPrint('Error picking Accident image: $e');
    }
  }
        ...
        child: TweenAnimationBuilder<double>(
          ...
          child: Column(
            ...
            children: [
              ...
              _AccidentPulsingText(text: 'Menyiapkan kamera...', color: _kAccent),
            ],
          ),
        ),
      ),
            ...
            Positioned(
              ...
              child: SafeArea(
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      _AccidentCameraIconButton(
                        icon: Icons.arrow_back_ios_new_rounded,
                        onTap: () => Navigator.pop(context, null),
                        size: 52,
                      ),
                      const SizedBox(width: 10),
                      // LABEL: ACCIDENT REPORT PHOTO
                      Expanded(
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              const Icon(Icons.health_and_safety_outlined, color: _kAccent, size: 20),
...
class _AccidentCameraIconButton extends StatelessWidget {
  final IconData icon;
  final VoidCallback onTap;
  final double size;

  const _AccidentCameraIconButton({
    required this.icon,
    required this.onTap,
    this.size = 44,
  });
...
class _AccidentFlashButton extends StatelessWidget {
  final bool supported;
  final bool enabled;
  final VoidCallback onTap;

  const _AccidentFlashButton({
...
class _AccidentPulsingText extends StatefulWidget {
  final String text;
  final Color color;

  const _AccidentPulsingText({required this.text, required this.color});

  @override
  State<_AccidentPulsingText> createState() => _AccidentPulsingTextState();
}

class _AccidentPulsingTextState extends State<_AccidentPulsingText> with SingleTickerProviderStateMixin {
