...
class FindingsVerificationDetailScreen extends StatefulWidget {
  final String lang;
  final Map<String, dynamic> item;
  final int initialTab;

  const FindingsVerificationDetailScreen({
    super.key,
    required this.lang,
    required this.item,
    this.initialTab = 0,
  ...
  @override
  State<FindingsVerificationDetailScreen> createState() =>
      _FindingsVerificationDetailScreenState();
}

class _FindingsVerificationDetailScreenState
    extends State<FindingsVerificationDetailScreen>
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Center(
              child: Text(
                t('Detail Verifikasi Temuan', 'Findings Verification Detail', '发现验证详情'),
