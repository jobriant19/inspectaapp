...
class AccidentVerificationIndicator extends StatelessWidget {
  final int currentPage;
  final int totalPages;
  final ValueChanged<int> onPageChanged;

  const AccidentVerificationIndicator({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    // Pastikan full visibility di semua HP: dengan navigation bar sistem
    // maupun gesture navigation (tanpa navbar).
