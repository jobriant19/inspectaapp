...
class KtsSolutionCameraWarmupService {
  KtsSolutionCameraWarmupService._();
  static final KtsSolutionCameraWarmupService instance = KtsSolutionCameraWarmupService._();
  ...
  Future<void> warmUp() async {
    ...
    try {
      ...
      debugPrint('Error warming up KTS solution camera: $e');
    } finally {
      isWarming = false;
    }
  }
...
class KtsSolutionCameraScreen extends StatefulWidget {
  final String lang;
  const KtsSolutionCameraScreen({super.key, required this.lang});

  @override
  State<KtsSolutionCameraScreen> createState() => _KtsSolutionCameraScreenState();
}

class _KtsSolutionCameraScreenState extends State<KtsSolutionCameraScreen> with WidgetsBindingObserver {
  ...
  String _txt(String key) {
    const Map<String, Map<String, String>> texts = {
      'EN': {
        'label': 'KTS Solution Photo',
        'preparing_camera': 'Preparing camera...',
      },
      'ID': {
        'label': 'Foto Solusi KTS',
  ...
  Future<void> _initCamera() async {
    final warm = KtsSolutionCameraWarmupService.instance;
    ...
    try {
      ...
      debugPrint('Error initializing KTS solution camera: $e');
    }
  }
  ...
  Future<void> _setCamera(int index) async {
    ...
    try {
      ...
      debugPrint('Error setting KTS solution camera: ${e.code}\n${e.description}');
    }
  }
  ...
  Future<void> _takePicture() async {
    ...
    try {
      ...
      debugPrint('Error taking KTS solution picture: ${e.code}\n${e.description}');
      if (mounted) {
  ...
  Future<void> _pickFromGallery() async {
    try {
      ...
      debugPrint('Error picking KTS solution image: $e');
    }
  }
        ...
        child: TweenAnimationBuilder<double>(
          ...
          child: Column(
            ...
            children: [
              ...
              _KtsSolutionPulsingText(text: _txt('preparing_camera'), color: _kAccent),
            ],
          ),
        ),
      ),
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              const Icon(CupertinoIcons.wrench_fill, color: _kAccent, size: 20),
...
class _KtsSolutionCameraIconButton extends StatelessWidget {
  final IconData icon;
  final VoidCallback onTap;
  final double size;

  const _KtsSolutionCameraIconButton({
    required this.icon,
    required this.onTap,
    this.size = 44,
  });
...
class _KtsSolutionFlashButton extends StatelessWidget {
  final bool supported;
  final bool enabled;
  final VoidCallback onTap;

  const _KtsSolutionFlashButton({
...
class _KtsSolutionPulsingText extends StatefulWidget {
  final String text;
  final Color color;

  const _KtsSolutionPulsingText({required this.text, required this.color});

  @override
  State<_KtsSolutionPulsingText> createState() => _KtsSolutionPulsingTextState();
}

class _KtsSolutionPulsingTextState extends State<_KtsSolutionPulsingText> with SingleTickerProviderStateMixin {
