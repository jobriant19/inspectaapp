            ...
            child: GestureDetector(
              onTap: () async {
                await Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => _JenisAuditManagerScreen(
                      lang: widget.lang,
...
// ============================================================
// JENIS AUDIT MANAGER SCREEN
// ============================================================
class _JenisAuditManagerScreen extends StatefulWidget {
  final String lang;
  final List<Map<String, dynamic>> initialList;
  final VoidCallback onChanged;

  const _JenisAuditManagerScreen({
    required this.lang,
  ...
  @override
  State<_JenisAuditManagerScreen> createState() =>
      _JenisAuditManagerScreenState();
}

class _JenisAuditManagerScreenState extends State<_JenisAuditManagerScreen> {
  final _supabase = Supabase.instance.client;
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  autofocus: true,
                  decoration: InputDecoration(
                    hintText: _t('e.g. Performance', 'cth. Performa', '例如：绩效'),
                    hintStyle: GoogleFonts.poppins(
                        fontSize: 13, color: Colors.grey.shade400),
                    filled: true,
                    fillColor: _C.surface,
                          ...
                          : () async {
                              ...
                              try {
                                ...
                                _showSuccessPopup(
                                  ...
                                  msgZh: isEdit ? '审计类型已成功更新。' : '审计类型已成功添加。',
                                );
                              } catch (e) {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  Text(
                    _t('Delete Audit Type?', 'Hapus Jenis Audit?', '删除审计类型？'),
                    style: GoogleFonts.poppins(
                        fontSize: 16,
                        fontWeight: FontWeight.w700,
                        color: _C.textMain),
  ...
  List<Map<String, dynamic>> get _filtered {
    ...
    // Urutkan dari terlama → terbaru (ascending urutan) untuk tampilan card
    result.sort((a, b) =>
            ...
            child: Container(
              ...
              child: TextField(
                ...
                style: GoogleFonts.poppins(
                    fontSize: 13, color: _C.textMain),
                decoration: InputDecoration(
                  hintText: _t('Search audit type...',
                      'Cari jenis audit...', '搜索审计类型...'),
                  hintStyle: GoogleFonts.poppins(
