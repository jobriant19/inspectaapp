...
class _AuditQuestionManagerScreenState
  ...
  Future<void> _showAddJenisAuditDialog() async {
                          ...
                          : () async {
                              ...
                              try {
                                ...
                                await _supabase
                                  ...
                                  'nama_en': t['en'],
                                  'nama_zh': t['zh'],
                                  'urutan': _jenisAuditList.length + 1,
                                });
                                if (ctx.mounted) Navigator.pop(ctx);
                                _fetchJenisAudit();
                              } catch (e) {
                                debugPrint('Error add jenis_audit: $e');
                                if (ctx.mounted) {
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              onTap: _showAddJenisAuditDialog,
              child: Container(
                padding:
            ...
            Container(
              ...
              child: Container(
                ...
                child: TabBar(
                  ...
                  // ≤4 TAB → FILL; >4 → HORIZONTAL SCROLL
