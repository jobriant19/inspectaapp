...
class AdminSubunitCameraWarmupService {
  AdminSubunitCameraWarmupService._();
  static final AdminSubunitCameraWarmupService instance =
      AdminSubunitCameraWarmupService._();
  ...
  Future<void> warmUp() async {
    ...
    try {
      ...
      debugPrint('Error warming up Admin Subunit camera: $e');
    } finally {
      isWarming = false;
    }
  }
...
class AdminSubunitCameraScreen extends StatefulWidget {
  final String lang;

  const AdminSubunitCameraScreen({
    super.key,
    this.lang = 'ID',
  });

  @override
  State<AdminSubunitCameraScreen> createState() =>
      _AdminSubunitCameraScreenState();
}

class _AdminSubunitCameraScreenState extends State<AdminSubunitCameraScreen>
  ...
  static const Color _kAccent = Color(0xFFFBBF24);
  ...
  Future<void> _initCamera() async {
    final warm = AdminSubunitCameraWarmupService.instance;
    ...
    try {
      ...
      debugPrint('Error initializing Admin Subunit camera: $e');
    }
  }
  ...
  Future<void> _setCamera(int index) async {
    ...
    try {
      ...
      debugPrint(
          'Error setting Admin Subunit camera: ${e.code}\n${e.description}');
    }
  }
  ...
  Future<void> _takePicture() async {
    ...
    try {
      ...
      debugPrint(
          'Error taking Admin Subunit picture: ${e.code}\n${e.description}');
      if (mounted) {
  ...
  Future<void> _pickFromGallery() async {
    try {
      ...
      debugPrint('Error picking Admin Subunit image: $e');
    }
  }
        ...
        child: TweenAnimationBuilder<double>(
          ...
          child: Column(
            ...
            children: [
              ...
              _AdminSubunitCameraPulsingText(text: _loadingText, color: _kAccent),
            ],
          ),
        ),
      ),
            ...
            Positioned(
              ...
              child: SafeArea(
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      _AdminSubunitCameraIconButton(
                        icon: Icons.arrow_back_ios_new_rounded,
                        onTap: () => Navigator.pop(context, null),
                        size: 52,
                      ),
                      const SizedBox(width: 10),
                      // LABEL: SUB-UNIT PHOTO
                      Expanded(
                        child: Container(
                      ...
                      const SizedBox(width: 10),
                      _AdminSubunitCameraFlashButton(
...
class _AdminSubunitCameraIconButton extends StatelessWidget {
  final IconData icon;
  final VoidCallback onTap;
  final double size;

  const _AdminSubunitCameraIconButton({
    required this.icon,
    required this.onTap,
    this.size = 44,
  });
...
class _AdminSubunitCameraFlashButton extends StatelessWidget {
  final bool supported;
  final bool enabled;
  final VoidCallback onTap;

  const _AdminSubunitCameraFlashButton({
...
class _AdminSubunitCameraPulsingText extends StatefulWidget {
  final String text;
  final Color color;

  const _AdminSubunitCameraPulsingText({required this.text, required this.color});

  @override
  State<_AdminSubunitCameraPulsingText> createState() =>
      _AdminSubunitCameraPulsingTextState();
}

class _AdminSubunitCameraPulsingTextState
    extends State<_AdminSubunitCameraPulsingText>
