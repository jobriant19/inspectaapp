...
class AdminAddSubunitDialog extends StatefulWidget {
  final String lang;
  final List<Map<String, dynamic>> subunits;
  final Future<void> Function() onSaved;

  const AdminAddSubunitDialog({
    super.key,
    required this.lang,
  ...
  @override
  State<AdminAddSubunitDialog> createState() => _AdminAddSubunitDialogState();
}

class _AdminAddSubunitDialogState extends State<AdminAddSubunitDialog> {
  ...
  Future<void> _loadMappingLists() async {
    try {
      ...
      debugPrint('Error load mapping list (add subunit): $e');
    }
  }
  ...
  void _openFullscreenPreview() {
    ...
    Navigator.push(
      ...
      PageRouteBuilder(
        ...
        pageBuilder: (_, __, ___) => _SubunitFullscreenImageViewer(
          imageUrl: url ?? '',
  ...
  Future<void> _onTapPhoto() async {
    ...
    try {
      ...
      final fileName = 'new-subunit-${DateTime.now().millisecondsSinceEpoch}.$safeExt';
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      child: (avatarUrl == null || avatarUrl.isEmpty)
                          ? const Icon(Icons.person_rounded, color: _C.primaryDark, size: 18)
                          : null,
                    ),
                    ...
                    Expanded(
                      child: Text(
                        enabled
                            ...
                            : _t('Select Unit first', 'Pilih Unit dahulu', '请先选择单位'),
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                height: 64,
                decoration: BoxDecoration(
                  color: (isSuccess ? _C.locationCol : _C.red).withValues(alpha: 0.12),
                  shape: BoxShape.circle,
                ),
                child: Icon(isSuccess ? Icons.check_circle_rounded : Icons.error_rounded,
                    color: isSuccess ? _C.locationCol : _C.red, size: 34),
              ),
              ...
              Text(message,
                  style: GoogleFonts.poppins(fontSize: 12.5, color: _C.textSub, height: 1.4),
                  textAlign: TextAlign.center),
  ...
  Future<void> _handleSave() async {
    ...
    try {
      ...
      _showResultDialog(
        ...
        message: _t('New subunit has been saved successfully.', 'Subunit baru berhasil disimpan.', '新子单位已成功保存。'),
      );
    } catch (e) {
      debugPrint('Error save subunit: $e');
          ...
          children: [
            Container(
              ...
              child: Row(children: [
                ...
                Expanded(
                  child: Text(
                    _t('Add Subunit', 'Tambah Subunit', '添加子单位'),
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      hasUnit
                          ? _t('Only users at the selected unit can be assigned.',
                              'Hanya pengguna pada unit terpilih yang bisa ditugaskan.', '只能指派所选单位的用户。')
                          : _t('Select Unit above first.',
                              'Pilih Unit di atas terlebih dahulu.', '请先选择上方的单位。'),
                      style: GoogleFonts.poppins(fontSize: 10, fontWeight: FontWeight.w600, color: _C.textSub),
                    ),
                    const SizedBox(height: 6),
                    _buildPicField(
      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            Text(_t('No results found', 'Tidak ada hasil', '没有结果'),
...
class _SubunitPicPickerDialogState extends State<_SubunitPicPickerDialog> {
  ...
  Future<void> _openRoleFilter() async {
    final result = await showDialog<Map<String, dynamic>?>(
      context: context,
      barrierDismissible: true,
      builder: (ctx) => _SubunitRoleFilterDialog(
        lang: widget.lang,
          ...
          Padding(
            ...
            child: Row(children: [
              Container(
                ...
                child: const Icon(Icons.person_search_rounded, color: _C.primaryDark, size: 20),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: Text(_t('Select Person in Charge', 'Pilih Penanggung Jawab', '选择负责人'),
                    style: GoogleFonts.poppins(fontWeight: FontWeight.w700, fontSize: 16, color: _C.primaryDark)),
              ),
              GestureDetector(
                onTap: () => Navigator.pop(context),
                child: Container(
              ...
              Container(
                ...
                child: Row(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  Text('${_filtered.length} ${_t('users', 'pengguna', '位用户')}',
                      style: GoogleFonts.poppins(color: _C.primaryDark, fontSize: 11, fontWeight: FontWeight.w700)),
                ]),
              ),
                                ...
                                if (avatarUrl != null && avatarUrl.isNotEmpty)
                                  ...
                                  CircleAvatar(
                                    ...
                                    child: Text(name.isNotEmpty ? name[0].toUpperCase() : '?',
                                        style: GoogleFonts.poppins(fontWeight: FontWeight.bold, fontSize: 15, color: isSelected ? Colors.white : _C.primaryDark)),
                                  ),
                                const SizedBox(width: 12),
                                Expanded(
                                  child: Column(
          ...
          children: [
            Image.asset(
              ...
              errorBuilder: (_, __, ___) => Container(
                ...
                child: const Icon(Icons.person_search_rounded, size: 34, color: _C.primaryDark),
              ),
            ),
            const SizedBox(height: 14),
            ...
            Text(
              isSearching
                  ...
                  : _t('No users available at this location/unit.', 'Tidak ada pengguna di lokasi/unit ini.', '此位置/单位没有可用用户。'),
              style: GoogleFonts.poppins(fontSize: 11.5, color: _C.textSub, height: 1.4), textAlign: TextAlign.center,
            ),
            if (isSearching) ...[
              const SizedBox(height: 14),
              GestureDetector(
          ...
          Padding(
            ...
            child: Row(children: [
              Container(
                padding: const EdgeInsets.all(8),
                decoration: BoxDecoration(color: _C.primaryLt, borderRadius: BorderRadius.circular(10)),
                child: const Icon(Icons.badge_rounded, color: _C.primaryDark, size: 20),
              ),
              const SizedBox(width: 12),
                            ...
                            child: Column(mainAxisSize: MainAxisSize.min, children: [
                              Image.asset(
                                ...
                                errorBuilder: (_, __, ___) => Container(
                                  ...
                                  height: 72,
                                  decoration: BoxDecoration(color: _C.primary.withValues(alpha: 0.08), shape: BoxShape.circle),
                                  child: const Icon(Icons.search_off_rounded, size: 34, color: _C.primaryDark),
                                ),
                              ),
                              const SizedBox(height: 14),
