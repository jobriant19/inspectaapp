...
class AdminSubunitLocationFilterDialog extends StatefulWidget {
  final String lang;
  final String? initialField;
  final String? initialValue;

  const AdminSubunitLocationFilterDialog({
    super.key,
    required this.lang,
    this.initialField,
    this.initialValue,
  ...
  @override
  State<AdminSubunitLocationFilterDialog> createState() => _AdminSubunitLocationFilterDialogState();
}

class _AdminSubunitLocationFilterDialogState extends State<AdminSubunitLocationFilterDialog> {
  static const _levels = ['Lokasi', 'Unit', 'Area'];
  static const _levelColors = [Color(0xFF10B981), Color(0xFF6366F1), Color(0xFFF472B6)];
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (_tabIndex == 2 && subunitName != null && subunitName.isNotEmpty) ...[
                    ...
                    Row(
                      children: [
                        const Icon(Icons.layers_rounded, size: 11, color: _C.primary),
...
class AdminSubunitSortDialog extends StatelessWidget {
  final Color primaryColor;
  final String currentSort;
  final String lang;
  final void Function(String sort) onSelect;

  const AdminSubunitSortDialog({
    super.key,
