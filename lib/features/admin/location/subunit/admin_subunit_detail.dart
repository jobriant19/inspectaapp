...
class AdminSubunitDetailScreen extends StatefulWidget {
  ...
  const AdminSubunitDetailScreen({
    super.key,
    required this.item,
    required this.lang,
  ...
  @override
  State<AdminSubunitDetailScreen> createState() => _AdminSubunitDetailScreenState();
}

class _AdminSubunitDetailScreenState extends State<AdminSubunitDetailScreen> {
  ...
  Future<void> _loadFavoriteCount() async {
    try {
      final idValue = _item['id_subunit'].toString();
  ...
  Future<void> _printQrCard() async {
    await QrPrintHelper.printQrCard(_qrCardKey, fileName: 'qr_subunit');
  }
  ...
  void _openFullImage(String url) {
    Navigator.push(
      ...
      PageRouteBuilder(
        ...
        pageBuilder: (_, __, ___) => _SubunitDetailFullscreenViewer(imageUrl: url),
      ),
    );
  }
            ...
            if (_isRefreshing)
              ...
              Container(
                ...
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Icon(Icons.info_rounded, size: 18, color: Color(0xFFB45309)),
                    const SizedBox(width: 10),
                    Expanded(
                      child: Text(
                        widget.lang == 'EN'
                          ...
                          child: Column(
                            children: [
                              ...
                              Row(
                                ...
                                mainAxisSize: MainAxisSize.min,
                                children: [
                                  Icon(widget.icon, size: 16, color: const Color(0xFFB45309)),
                                  const SizedBox(width: 6),
                                  Flexible(
                                    child: Text(
                                      name,
                              ...
                              Row(
                                ...
                                children: [
                                  Text(
                                    ...
                                    style: GoogleFonts.poppins(
                                        color: const Color(0xFFB45309), fontSize: 12.5, fontWeight: FontWeight.w700),
                                  ),
                                  CircleAvatar(
                                    radius: 12,
                                    backgroundColor: widget.primaryColor.withValues(alpha: 0.20),
                                    backgroundImage: (picImage != null && picImage.isNotEmpty)
                                        ...
                                        : null,
                                    child: (picImage == null || picImage.isEmpty)
                                        ? const Icon(Icons.person_rounded, color: Color(0xFFB45309), size: 13)
                                        : null,
                                  ),
                                  const SizedBox(width: 6),
                                  Flexible(
...
class _SubunitDetailFullscreenViewer extends StatelessWidget {
  final String imageUrl;

  const _SubunitDetailFullscreenViewer({required this.imageUrl});
