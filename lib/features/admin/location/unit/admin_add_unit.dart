...
class AdminAddUnitDialog extends StatefulWidget {
  final String lang;
  final List<Map<String, dynamic>> lokasiList;
  final Future<void> Function() onSaved;

  const AdminAddUnitDialog({
    super.key,
    required this.lang,
  ...
  @override
  State<AdminAddUnitDialog> createState() => _AdminAddUnitDialogState();
}

class _AdminAddUnitDialogState extends State<AdminAddUnitDialog> {
  ...
  Future<void> _onTapPhoto() async {
    ...
    try {
      ...
      final fileName = 'new-unit-${DateTime.now().millisecondsSinceEpoch}.$safeExt';
  ...
  Future<void> _handleSave() async {
    ...
    await _supabase.from('unit').insert(data);
