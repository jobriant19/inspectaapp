...
class AdminAreaLocationFilterDialog extends StatefulWidget {
  final String lang;
  final String? initialField;
  final String? initialValue;

  const AdminAreaLocationFilterDialog({
    super.key,
    required this.lang,
    this.initialField,
    this.initialValue,
  ...
  @override
  State<AdminAreaLocationFilterDialog> createState() => _AdminAreaLocationFilterDialogState();
}

class _AdminAreaLocationFilterDialogState extends State<AdminAreaLocationFilterDialog> {
  static const _levels = ['Lokasi', 'Unit', 'Subunit'];
  static const _levelColors = [Color(0xFF10B981), Color(0xFF6366F1), Color(0xFFFBBF24)];
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      _dialogTitle,
                      style: GoogleFonts.poppins(fontWeight: FontWeight.w800, fontSize: 15, color: _C.textMain),
                    ),
                  ),
                  GestureDetector(
...
class AdminAreaSortDialog extends StatelessWidget {
  final Color primaryColor;
  final String currentSort;
  final String lang;
  final void Function(String sort) onSelect;

  const AdminAreaSortDialog({
    super.key,
