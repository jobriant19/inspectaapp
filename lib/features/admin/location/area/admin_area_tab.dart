...
class _AdminAreaTabState extends State<AdminAreaTab>
  ...
  void _showLocationFilterDialog() async {
    final result = await showDialog<Map<String, dynamic>>(
      context: context,
      barrierDismissible: true,
      builder: (ctx) => AdminAreaLocationFilterDialog(
        lang: widget.lang,
  ...
  void _showSortDialog() {
    showDialog(
      context: context,
      builder: (ctx) => AdminAreaSortDialog(
        primaryColor: _primary,
          ...
          child: Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: lang == 'EN' ? 'Search Area...' : lang == 'ZH' ? '搜索区域...' : 'Cari Area...',
                          ...
                          children: [
                            ...
                            Text(
                              isFiltering
                                  ...
                                  : (lang == 'EN'
                                      ? 'Areas will show up here as soon as they\'re added.'
                                      : lang == 'ZH'
                                          ? '添加区域后将显示在此处。'
                                          : 'Area akan muncul di sini setelah ditambahkan.'),
                              style: GoogleFonts.poppins(
                                fontSize: 12.5,
