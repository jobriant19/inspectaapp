...
class AdminKtsMembersTab extends StatefulWidget {
  ...
  @override
  State<AdminKtsMembersTab> createState() => _AdminKtsMembersTabState();
}

class _AdminKtsMembersTabState extends State<AdminKtsMembersTab> {
  ...
  Future<List<_AdminKtsMemberData>>? _anggotaFuture;
  ...
  Future<void> _resolveUserId() async {
    ...
    try {
      ...
      if (fromPrefs != null && fromPrefs.isNotEmpty) {
        _resolvedUserId = fromPrefs;
        return;
      }
    } catch (e) {
      debugPrint('Error resolving userId from SharedPreferences: $e');
    }
    _resolvedUserId = _supabase.auth.currentUser?.id ?? '';
  }
  ...
  Future<List<_AdminKtsMemberData>> _fetchKtsAnggotaData(
  ...
  Future<List<_AdminKtsMemberData>> _fetchKtsAnggotaDataDaily(
        ...
        builder: (ctx, setSt) => Dialog(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: _AdminKtsMembersColors.primaryLight, width: 1.5),
            ),
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                    color: _AdminKtsMembersColors.primaryLight,
                    borderRadius: BorderRadius.vertical(top: Radius.circular(20)),
                  ),
                  child: Row(children: [
                    const Icon(Icons.calendar_month_rounded,
                        color: _AdminKtsMembersColors.primary, size: 20),
                    const SizedBox(width: 8),
                    Expanded(child: Text(getTxt('pilih_bulan'),
                        style: const TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 15,
                            color: _AdminKtsMembersColors.textPrimary))),
                    IconButton(
                      icon: const Icon(Icons.close,
                          size: 18, color: _AdminKtsMembersColors.textSecondary),
                ...
                Padding(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      color: _AdminKtsMembersColors.surface,
                      borderRadius: BorderRadius.circular(12),
                      border: Border.all(color: _AdminKtsMembersColors.primaryLight),
                    ),
                        ...
                        return Expanded(
                          child: GestureDetector(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                color: isSelected
                                    ? _AdminKtsMembersColors.primary
                                    : Colors.transparent,
                              ...
                              child: Center(
                                child: Text(label,
                                    style: TextStyle(
                                      ...
                                      color: isSelected
                                          ? Colors.white
                                          : _AdminKtsMembersColors.textSecondary,
                                    )),
                              ),
                            ),
                          ),
                        ...
                        return GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              color: isSelected
                                  ? _AdminKtsMembersColors.primary
                                  : _AdminKtsMembersColors.surface,
                              borderRadius: BorderRadius.circular(10),
                              border: Border.all(
                                color: isSelected
                                    ? _AdminKtsMembersColors.primary
                                    : _AdminKtsMembersColors.divider,
                                width: isSelected ? 1.5 : 1,
                              ),
                              boxShadow: isSelected
                                  ? [
                                      BoxShadow(
                                        color: _AdminKtsMembersColors.primary
                            ...
                            child: Center(
                              child: Text(
                                ...
                                style: TextStyle(
                                  ...
                                  color: isSelected
                                      ? Colors.white
                                      : _AdminKtsMembersColors.textPrimary,
                                ),
                              ),
                            ),
                          ),
            ...
            children: [
              IconButton(
                icon: const Icon(Icons.chevron_left_rounded,
                    size: 20, color: _AdminKtsMembersColors.primary),
                      ...
                      child: Center(
                        child: Text(d,
                            style: const TextStyle(
                                ...
                                color: _AdminKtsMembersColors.textSecondary)),
                      ),
                    ))
                .toList(),
          ),
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: isSelected
                        ? _AdminKtsMembersColors.primary
                        : isToday
                            ? _AdminKtsMembersColors.primaryLight
                            : Colors.transparent,
                    shape: BoxShape.circle,
                    border: isToday && !isSelected
                        ? Border.all(
                            color: _AdminKtsMembersColors.primary, width: 1.2)
                        : null,
                  ),
                  child: Center(
                    child: Text('$day',
                        style: TextStyle(
                          ...
                          color: isSelected
                              ? Colors.white
                              : isFuture
                                  ? _AdminKtsMembersColors.textMuted
                                  : _AdminKtsMembersColors.textPrimary,
                        )),
                  ),
                ),
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: _AdminKtsMembersColors.primary,
          ...
          return Dialog(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(20),
                border:
                    Border.all(color: _AdminKtsMembersColors.primaryLight, width: 1.5),
              ),
              child: Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                      ...
                      builder: (_, setInner) => TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintStyle: const TextStyle(
                              fontSize: 13, color: _AdminKtsMembersColors.textMuted),
                          prefixIcon: const Icon(Icons.search,
                              color: _AdminKtsMembersColors.primary, size: 18),
                          filled: true,
                          fillColor: _AdminKtsMembersColors.surface,
                          contentPadding: const EdgeInsets.symmetric(
                              vertical: 8, horizontal: 12),
                          border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(30),
                              borderSide: const BorderSide(
                                  color: _AdminKtsMembersColors.divider)),
                          ...
                          focusedBorder: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(30),
                              borderSide: const BorderSide(
                                  color: _AdminKtsMembersColors.primary, width: 1.5)),
                        ),
                      ),
                    ),
                  ),
    ...
    return Shimmer.fromColors(
      ...
      child: ListView.separated(
        ...
        separatorBuilder: (_, __) =>
            const Divider(height: 1, color: _AdminKtsMembersColors.divider, indent: 16),
  ...
  Widget _buildMemberTimeFilterButton() {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isActive ? _AdminKtsMembersColors.primary : Colors.white,
          borderRadius: BorderRadius.circular(10),
          border: Border.all(
            color: isActive ? _AdminKtsMembersColors.primary : _AdminKtsMembersColors.primaryLight,
            width: 1.5,
          ),
          boxShadow: [
            BoxShadow(
                color: _AdminKtsMembersColors.primary.withValues(alpha: 0.10),
                blurRadius: 6,
                offset: const Offset(0, 2)),
          ],
        ),
        child: Row(children: [
            ...
            child: Row(
              ...
              children: [
                Icon(Icons.calendar_month_rounded,
                    size: 15,
                    color: isActive ? Colors.white : _AdminKtsMembersColors.primary),
          ...
          Icon(Icons.keyboard_arrow_down_rounded,
              color: isActive ? Colors.white : _AdminKtsMembersColors.primary, size: 18),
        ]),
      ),
    );
  }
  ...
  Widget _buildMemberRow(_AdminKtsMemberData m) {
    ...
    return Container(
      color: m.isSelf ? _AdminKtsMembersColors.selfHighlight : Colors.white,
  ...
  Widget _buildSelfPinnedRow(_AdminKtsMemberData self) {
    final target = _targetAnggota;
    ...
    return Container(
      decoration: BoxDecoration(
        color: _AdminKtsMembersColors.selfHighlight,
        border: const Border(
            top: BorderSide(
                color: _AdminKtsMembersColors.selfHighlightBorder, width: 1.5)),
        boxShadow: [
          BoxShadow(
  ...
  Widget _buildChartToggleHeader() {
    const activeColor = _AdminKtsMembersColors.primary;
    final locale = widget.lang == 'ID'
        ? 'id_ID'
        : (widget.lang == 'EN' ? 'en_US' : 'zh_CN');
      ...
      children: [
        ...
        AnimatedSize(
          ...
          child: _isChartExpanded
              ? FutureBuilder<List<_AdminKtsMemberData>>(
            ...
            Row(
              children: [
                SizedBox(
                  ...
                  height: 130,
                  child: CustomPaint(
                    painter: _AdminKtsMembersPieChartPainter(
  ...
  Widget build(BuildContext context) {
    return Column(children: [
          ...
          child: Container(
            ...
            child: Row(mainAxisSize: MainAxisSize.min, children: [
              const Icon(Icons.access_time_filled_rounded,
                  size: 13, color: _AdminKtsMembersColors.primary),
              const SizedBox(width: 6),
      ...
      Expanded(child: Builder(builder: (context) {
        ...
        return FutureBuilder<List<_AdminKtsMemberData>>(
          future: _anggotaFuture,
          builder: (context, snapshot) {
...
class _KTSAvatar extends StatelessWidget {
  ...
  Widget _buildInitials() {
    final initials = name
        ...
        .join();
    final bg = color ?? _AdminKtsMembersColors.primary;
...
// PIE CHART PAINTER
class _AdminKtsMembersPieChartPainter extends CustomPainter {
  ...
  _AdminKtsMembersPieChartPainter({
