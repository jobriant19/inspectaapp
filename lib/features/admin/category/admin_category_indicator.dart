...
class AdminCategoryPageIndicator extends StatelessWidget {
  ...
  const AdminCategoryPageIndicator({
    super.key,
...
const int kAdminCategoryListPageSize = 10;

const int kAdminCategorySelectPageSize = 5;