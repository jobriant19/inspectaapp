...
/// Konten tab Preventif Maintenance tanpa Scaffold/header/bottomnav.
/// Header & bottom navbar sekarang dikelola oleh AdminShellScreen.
class AdminPreventifBody extends StatefulWidget {
  final String lang;
  const AdminPreventifBody({super.key, required this.lang});

  @override
  State<AdminPreventifBody> createState() => _AdminPreventifBodyState();
}

class _AdminPreventifBodyState extends State<AdminPreventifBody> {
  ...
  @override
  void didUpdateWidget(covariant AdminPreventifBody oldWidget) {
