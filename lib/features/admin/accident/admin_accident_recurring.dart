...
class AdminAccidentRecurringTab extends StatefulWidget {
  ...
  @override
  State<AdminAccidentRecurringTab> createState() => AdminAccidentRecurringTabState();
}

class AdminAccidentRecurringTabState extends State<AdminAccidentRecurringTab> {
  ...
  // FILTER BUTTON (disamakan persis dengan gaya di AnalyticsAccidentTab)
      ...
      Expanded(child: FutureBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (_, snap) {
          ...
          return ListView.separated(
            ...
            itemBuilder: (_, i) => _AdminAccidentRecurringCard(
              group:  groups[i],
              lang:   widget.lang,
        ...
        builder: (_, ctrl) => Container(
          ...
          child: Column(children: [
            ...
            Expanded(child: ListView.separated(
              ...
              itemBuilder: (_, i) => _AdminAccidentReportCard(
...
class _AdminAccidentRecurringCard extends StatelessWidget {
  final Map<String, dynamic> group;
  final String               lang;
  final VoidCallback         onTap;
  const _AdminAccidentRecurringCard(
...
class _AdminAccidentReportCard extends StatelessWidget {
  final Map<String, dynamic> data;
  final String               lang;
  final String               locale;
  const _AdminAccidentReportCard(
